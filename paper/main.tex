...
\begin{tikzpicture}[
  font=\small,
  seqbox/.style={draw, rounded corners=3pt, minimum width=4.0cm, minimum height=0.75cm,
                 align=center, fill=blue!12, draw=blue!50, thick},
  tabbox/.style={draw, rounded corners=3pt, text width=4.2cm, inner sep=7pt,
                 align=left, fill=orange!12, draw=orange!50, thick},
  catbox/.style={draw, rounded corners=3pt, minimum width=6.8cm, minimum height=0.75cm,
                 align=center, fill=gray!12, draw=gray!50, thick},
  mlpbox/.style={draw, rounded corners=3pt, minimum width=6.8cm, minimum height=0.75cm,
                 align=center, fill=teal!12, draw=teal!50, thick},
  outbox/.style={draw, rounded corners=3pt, minimum width=4.0cm, minimum height=0.75cm,
...
%% ── Tabular branch (right column, x = 7.5) ───────────────────────────────
\node[tabbox] (tab) at (7.5, -1.75) {%
  \textbf{Tabular features (50-d)}\\[4pt]
  \small ref/alt AA one-hot \quad (40-d)\\[1pt]
  \small physchem $\Delta$ \quad\quad\quad\;\; (3-d)\\[1pt]
  \small consequence \quad\quad\quad\;\;\; (4-d)\\[1pt]
  \small pos + phyloP + Grantham (3-d)%
};

%% ── Concatenation (centre, x = 3.75) ─────────────────────────────────────
\node[catbox] (cat)  at (3.75, -5.4) {Concatenation \quad (818-d)};

%% ── MLP head ──────────────────────────────────────────────────────────────
\node[mlpbox] (mlp1) at (3.75, -6.8) {Linear $818{\to}256$ + LayerNorm + GELU + Dropout};
\node[mlpbox] (mlp2) at (3.75, -8.0) {Linear $256{\to}64$ + GELU + Dropout};
\node[mlpbox] (mlp3) at (3.75, -9.0) {Linear $64{\to}1$};

%% ── Output ────────────────────────────────────────────────────────────────
\node[outbox] (out)  at (3.75, -10.3) {Predicted SGE score};
...
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]{../results/figures/sge_regressor_scatter.png}
...
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]{../results/figures/sge_regressor_boxplot.png}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]{../results/figures/sge_regressor_scatter_brca2.png}
...
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]{../results/figures/sge_regressor_boxplot_brca2.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.75\textwidth]{../results/figures/baseline_comparison.png}
